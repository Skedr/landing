<template>
  <div class="relative py-8 bg-white space-y-8 overflow-hidden">
    ...
    <div>
      ...
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        <p>
          ...
          are set either on a monthly or annual basis, depending on the type of subscription plan
        ...
        <p>
          ...
          exact same conditions unless you cancel it or Skedr.io cancels it. You may cancel your
          Subscription renewal either through your online account management page or by contacting
          Skedr.io customer support team.
        </p>

        <p>
          A valid payment method, including credit card or PayPal, is required to process the
          payment for your Subscription. You shall provide Skedr.io with accurate and complete
          billing information including full name, address, state, zip code, telephone number, and a
          valid payment method information. By submitting such payment information, you
          automatically authorize Skedr.io to charge all Subscription fees incurred through your
          account to any such payment instruments.
        </p>

        <p>
          Should automatic billing fail to occur for any reason, Skedr.io will issue an electronic
        ...
        <p>
          Skedr.io will provide you with a reasonable prior notice of any change in Subscription
    ...
    <div>
      ...
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        <p>
          ...
          exclusive property of Skedr.io and its licensors. The Service is protected by copyright,
          trademark, and other laws of both the Spain and foreign countries. Our trademarks and
        ...
        <p>
          Skedr.io has no control over, and assumes no responsibility for, the content, privacy
          policies, or practices of any third party web sites or services. You further acknowledge
          and agree that Skedr.io shall not be responsible or liable, directly or indirectly, for
        ...
        <p>
          Skedr.io its subsidiaries, affiliates, and its licensors do not warrant that a) the
