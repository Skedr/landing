  ...
  <div class="relative py-8 bg-white space-y-8 overflow-hidden">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        <p>
          Skedr.io ("us", "we", or "our") operates the https://skedr.io website and the
          https://app.skedr.io software as a service application (the "Service").
        </p>
        <p>
          This page informs you of our policies regarding the collection, use, and disclosure of
          personal data when you use our Service and the choices you have associated with that data.
          Our Privacy Policy for Skedr.io is managed through
    ...
    <div>
      ...
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        ...
        <p>
          ...
          Some tracking technologies also used are beacons, tags, and scripts to collect and track
        ...
        <p>
          Skedr.io will take all steps reasonably necessary to ensure that your data is treated
    ...
    <div>
      ...
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        <p>
          Skedr.io may disclose your Personal Data in the good faith belief that such action is
          necessary to:
        </p>
        <ul role="list">
