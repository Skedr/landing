      ...
      >
        <blockquote class="mt-6 md:flex-grow md:flex md:flex-col">
          <div class="relative text-lg font-medium text-white md:flex-grow">
            ...
            <p class="relative">
              Skedr.io can handle 80 to 90% of my work, considerably reducing my posting time.
            </p>
          </div>
          <footer class="mt-8">
      ...
      >
        <blockquote class="mt-6 md:flex-grow md:flex md:flex-col">
          <div class="relative text-lg font-medium text-white md:flex-grow">
            ...
            <p class="relative">
              I like Skedr.io more than anything because it is easy to use and fast, something that
              in Flickr costs more to do.
            </p>
          </div>
          <footer class="mt-8">
            <div class="flex items-start">
              ...
              <div class="ml-4">
                <div class="text-base font-medium text-white">LuceMia</div>
                <div class="text-base font-medium text-indigo-200">4950 Photos</div>
              </div>
            </div>
          </footer>
        </blockquote>
