      ...
      <div class="relative flex justify-center">
        <div class="bg-indigo-700 p-0.5 rounded-lg flex">
          <button
            ...
            :class="{
              'text-indigo-700 hover:bg-indigo-50  bg-white':
                billingModeMonthly,
              ...
              >
                ...
                >
                  ...
                  <div v-if="discount !== 100" class="ml-4">
                    ...
                    <p
                      :class="[
                        plan.featured ? 'text-amber-500' : 'text-amber-500',
                        'text-sm',
                      ]"
                    >
                      Save {{ discount }}% off
                ...
                <a
                  ...
                  :class="[
                    plan.featured
                      ? 'bg-indigo-600 text-white hover:bg-indigo-700'
                      : 'bg-white text-indigo-600 hover:bg-indigo-50',
                    'try-it-for-free mt-6 w-full inline-block py-2 px-8 border border-transparent rounded-md shadow-sm text-center text-sm font-medium sm:mt-0 sm:w-auto lg:mt-6 lg:w-full',
                  ]"
                >
                  Try it for free
                </a>
                ...
                <dl class="divide-y divide-gray-200">
                  ...
                  >
                    ...
                    <dd class="text-center sm:px-4">
                      <span
                        v-if="
                          typeof item.tiers[mobilePlanIndex].value === 'string'
                        "
                        :class="[
                      ...
                      <template v-else>
                        ...
                        <span class="sr-only">
                          {{
                            item.tiers[mobilePlanIndex].value === true
                              ? "Yes"
                              : "No"
                          }}
                        </span>
