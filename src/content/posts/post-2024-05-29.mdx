...
image: /post-2024-05-29-tagging.png
...
Let’s take my current obsession with bird photography as an example. Here’s one of the photos in Flickr, Nesting at Tilapa Lodge: https://www.flickr.com/photos/enric-bisbe/53443526687/ 
...
With *only* four tags we could be easily sharing this photo into at least 15 different groups just in one step.
...
To configure each group you have to go to: "https://app.skedr.io/acc/groups". You can add tags to each group in three different ways:
...
Once you have configured as many groups as you want you can start sharing your photos. Just go to https://app.skedr.io/acc/photostream and hit the ‘Sync’ button on any photo with tags.
